...
bridge_ip = args.ip
# the user set an IP, ask him to press the link button, block the main process until a key is pressed
value = input("Please press the link button on your bridge and then press enter on your keyboard")
